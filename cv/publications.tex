...
\cvskill
    {} % Category
    {\textbf{J.J. Millar}, K.B. Toh, D. Valle. To screen or not to screen: an interactive framework for comparing cost-effectiveness of mass screening and treatment of malaria. \textit{In progress}} % Citation

\cvskill
    {} % Category
    {J.T. Payne, C.R. Jackson, \textbf{J.J. Millar}, C.A. Ochs. Timescales of variation in diversity and productivity of bacterioplankton assemblages in the Lower Mississippi River. \textit{Microbial Ecology}. In review.} % Citation
...
%---------------------------------------------------------
  \cvskill
    {2019} % Year
    {D. Valle, K.B. Toh, and \textbf{J.J. Millar}. Rapid prototyping of decision support tools for conservation. \textit{Conservation Biology}. In press.} % Citation
